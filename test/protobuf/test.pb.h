...
class GetFriendListResponese;
struct GetFriendListResponeseDefaultTypeInternal;
extern GetFriendListResponeseDefaultTypeInternal _GetFriendListResponese_default_instance_;
class LoginRequest;
...
template<> ::fixbug::GetFriendListResponese* Arena::CreateMaybeMessage<::fixbug::GetFriendListResponese>(Arena*);
...
class GetFriendListResponese final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendListResponese) */ {
 public:
  inline GetFriendListResponese() : GetFriendListResponese(nullptr) {}
  ~GetFriendListResponese() override;
  explicit PROTOBUF_CONSTEXPR GetFriendListResponese(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GetFriendListResponese(const GetFriendListResponese& from);
  GetFriendListResponese(GetFriendListResponese&& from) noexcept
    : GetFriendListResponese() {
    *this = ::std::move(from);
  }

  inline GetFriendListResponese& operator=(const GetFriendListResponese& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendListResponese& operator=(GetFriendListResponese&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const GetFriendListResponese& default_instance() {
    return *internal_default_instance();
  }
  static inline const GetFriendListResponese* internal_default_instance() {
    return reinterpret_cast<const GetFriendListResponese*>(
               &_GetFriendListResponese_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  friend void swap(GetFriendListResponese& a, GetFriendListResponese& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendListResponese* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(GetFriendListResponese* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  GetFriendListResponese* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GetFriendListResponese>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GetFriendListResponese& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const GetFriendListResponese& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendListResponese* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendListResponese";
  }
  protected:
  explicit GetFriendListResponese(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendListResponese)
 private:
  class _Internal;
...
// .fixbug.ResultCode result = 1;
inline bool GetFriendListResponese::_internal_has_result() const {
  return this != internal_default_instance() && result_ != nullptr;
}
inline bool GetFriendListResponese::has_result() const {
  return _internal_has_result();
}
inline void GetFriendListResponese::clear_result() {
  if (GetArenaForAllocation() == nullptr && result_ != nullptr) {
    delete result_;
  }
  result_ = nullptr;
}
inline const ::fixbug::ResultCode& GetFriendListResponese::_internal_result() const {
  const ::fixbug::ResultCode* p = result_;
  return p != nullptr ? *p : reinterpret_cast<const ::fixbug::ResultCode&>(
      ::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& GetFriendListResponese::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListResponese.result)
  return _internal_result();
}
inline void GetFriendListResponese::unsafe_arena_set_allocated_result(
    ::fixbug::ResultCode* result) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(result_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.GetFriendListResponese.result)
}
inline ::fixbug::ResultCode* GetFriendListResponese::release_result() {
...
inline ::fixbug::ResultCode* GetFriendListResponese::unsafe_arena_release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListResponese.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriendListResponese::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* GetFriendListResponese::mutable_result() {
  ::fixbug::ResultCode* _msg = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListResponese.result)
  return _msg;
}
inline void GetFriendListResponese::set_allocated_result(::fixbug::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete result_;
  }
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListResponese.result)
}

// repeated .fixbug.User friend_list = 2;
inline int GetFriendListResponese::_internal_friend_list_size() const {
  return friend_list_.size();
}
inline int GetFriendListResponese::friend_list_size() const {
  return _internal_friend_list_size();
}
inline void GetFriendListResponese::clear_friend_list() {
  friend_list_.Clear();
}
inline ::fixbug::User* GetFriendListResponese::mutable_friend_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListResponese.friend_list)
  return friend_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendListResponese::mutable_friend_list() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListResponese.friend_list)
  return &friend_list_;
}
inline const ::fixbug::User& GetFriendListResponese::_internal_friend_list(int index) const {
  return friend_list_.Get(index);
}
inline const ::fixbug::User& GetFriendListResponese::friend_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListResponese.friend_list)
  return _internal_friend_list(index);
}
inline ::fixbug::User* GetFriendListResponese::_internal_add_friend_list() {
  return friend_list_.Add();
}
inline ::fixbug::User* GetFriendListResponese::add_friend_list() {
  ::fixbug::User* _add = _internal_add_friend_list();
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListResponese.friend_list)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendListResponese::friend_list() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListResponese.friend_list)
  return friend_list_;
}
